...
SVC_NAME="actions.runner.Arkobat-simple-fortune-cookie.Simple Cookie.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Arkobat-simple-fortune-cookie.Simple Cookie)"
